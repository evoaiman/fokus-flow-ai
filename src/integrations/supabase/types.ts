...
export type Database = {
  public: {
    Tables: {
      ...
      fulfillment_shipping_profile_store_store: {
        Row: {
          created_at: string
          deleted_at: string | null
          id: string
      ...
      pricing_price_list_store_store: {
        Row: {
          created_at: string
          deleted_at: string | null
          id: string
      ...
      stock_location_stock_location_store_store: {
        Row: {
          created_at: string
          deleted_at: string | null
          id: string
